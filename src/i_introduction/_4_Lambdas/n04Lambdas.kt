...
fun JavaCode4.task4Fix(collection: Collection<Int>): Boolean = collection.any { it % 2 == 0 }

fun task4(collection: Collection<Int>): Boolean = JavaCode4().task4Fix(collection)